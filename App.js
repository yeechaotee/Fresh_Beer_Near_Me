...
function LogonLayout() {
  ...
  const [presentedNotificationCount, setPresentedNotificationCount] =
    useState(0);
  ...
  return (
    ...
    >
      ...
      />
      <Tab.Screen name="Discovery" component={RootNavigation} />
      <Tab.Screen
        name="Notification"
        component={NotificationsScreen}
        options={{
          tabBarBadge:
            presentedNotificationCount > 0 ? presentedNotificationCount : null,
        }}
      ></Tab.Screen>
...
function App() {
  ...
  const SignedInStack = () => (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Discovery">
        <Stack.Screen
          name="LoggedOn"
          component={LogonLayout}
          options={{ headerShown: false /*title: "Logon as " + user.email*/ }}
        />
        <Stack.Screen
          name="NewPostScreen"
  ...
  return (
    <>
      {user
        ? !loadingInitial && SignedInStack()
        : !loadingInitial && SignedOutStack()}
    </>
    // <NavigationContainer>
